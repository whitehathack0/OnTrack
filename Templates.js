    ...
    render() {
        return (
            ...
            {this.state.hasClickedMid && (
              ...
              <form>
                <fieldset>
                <legend>Edit Slack Item</legend>
                Here the manager can edit items
                <br/>
                <br/>
                <p align="left">
                ...
                <label for="exampleTextarea">Add instructions:</label>
                <textarea class="form-control" id="exampleTextarea" rows="3"></textarea>
                </div>
                </p>
                </fieldset>
              </form>
              <button class="btn btn-success" onClick={() => this.isDone()}>Update</button>
              <br/>
              <br/>
              <br/>
              <br/>
